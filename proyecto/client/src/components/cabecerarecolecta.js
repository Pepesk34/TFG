            ...
            <nav className="navbar bg-dark border-bottom border-body navbar-dark">
                <div className="container-fluid d-flex justify-content-center" id='containernav'>
                    ...
                    <ul className="navbar-nav">
                        <li className='nav-item nav-inicio'>
                            <Link className="nav-link" id='link-inicio' to="/inicio">
                        ...
                        <li className='nav-filtros'>
                            <button className="btn btn-dark" type='button' id='button-filtros'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-sort-alpha-down" viewBox="0 0 16 16">
                        ...
                        <li className='nav-perfil'>
                            <button className="btn btn-dark" type='button' id='button-perfil' onClick={() => handleShowModal()}>
                        ...
                        <li className='nav-ajustes'>
                            <button className="btn btn-dark" type='button' id='button-ajustes' >
