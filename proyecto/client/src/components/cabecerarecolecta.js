                ...
                <div className="container-fluid" id='containernav'>
                    ...
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        <li className="nav-item">
                            <Link className="nav-link" id='nav-inicio' to="/inicio">
                        ...
                        <li className="nav-item">
                            <Link className="nav-link" id='nav-filtros' to="/registrarse" onClick={handleClick}>
                        ...
                        <li className="nav-item btn-group" id='nav-perfil'>
                            <button className="nav-link" type='button' id='button-perfil'>
                        ...
                        <li className="nav-item btn-group" id='nav-ajustes'>
