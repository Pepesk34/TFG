            ...
            <div className="row fila-primera">
                <div className="col">
                    ...
                    <div className="row fila-segunda">
                        <div className='col'>
                            <button className="btn" type='button' id='button-logo'>
                    ...
                    <div className="row fila-segunda">
                        <div className='col'>
                            <button className="btn btn-light" type='button' id='button-inicio'>
                    ...
                    <div className="row fila-segunda">
                        <div className='col'>
                            <button className="btn btn-light" type='button' id='button-filtros'>
                    ...
                    <div className="row fila-segunda">
                        <div className='col'>
                            <button className="btn btn-light" type='button' id='button-perfil' onClick={() => handleShowModal()}>
                    ...
                    <div className="row fila-segunda">
                        <div className='col'>
                            <button className="btn btn-light" type='button' id='button-ajustes' >
